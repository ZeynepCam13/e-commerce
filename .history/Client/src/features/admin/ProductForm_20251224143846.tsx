...
import { Delete, Add, CloudUpload, ColorLens, Straighten } from "@mui/icons-material";
...
export default function ProductForm({ product, cancelEdit }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // ... (Mevcut form append mantığınız aynen kalıyor)
    ...
    <Container maxWidth="md" sx={{ py: 4 }}>
      <Paper elevation={3} sx={{ p: 4, borderRadius: 3 }}>
        ...
        <Box component="form" onSubmit={handleSubmit}>
          ...
          {/* SEKTÖR 3: VARYASYONLAR (RENK & BEDEN) */}
          ...
          <Box sx={{ border: '2px dashed #ccc', p: 3, textAlign: 'center', borderRadius: 2, bgcolor: '#fafafa' }}>
            ...
            <label htmlFor="file-upload">
              <Button component="span" startIcon={<CloudUpload />}>Dosya Seçin</Button>
            </label>
