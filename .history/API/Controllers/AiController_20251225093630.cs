...
public class AiController : ControllerBase
{
     ...
     if (!string.IsNullOrEmpty(cleanedMessage))
    {
       ...
       q = q.Where(p => 
         ...
         (p.subSubCategory != null && p.subSubCategory.Name.ToLower().Contains(search)) ||
    ...
    if (matchedCategoryId.HasValue)
    {
      ...
      q = q.Where(p => p.subSubCategoryId == matchedCategoryId.Value || p.Name.ToLower().Contains(cleanedMessage.ToLower()));
   }
