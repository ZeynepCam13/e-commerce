    ...
    <>
                    ...
                    onClick={() =>
                      dispatch(
                        deleteItemFromCart({
                          productId: item.productId,
                          quantity: 1,
                          size: item.size, // ✔ EKSİK OLAN EKLENDİ
                        })
                      )
                    }
                  >
                    ...
                    onClick={() =>
                      dispatch(
                        deleteItemFromCart({
                          ...
                          size: item.size, // ✔ FULL DELETE’TE DE OLMALI
                        })
                      )
                    }
                  >
      ...
      <Box display="flex" justifyContent="flex-end" sx={{ mt: 3 }}>
        <Button
          ...
          variant="contained"
          color="primary"
          sx={{ minWidth: "200px", height: "30px", fontSize: "18px", fontWeight: "bold" }}
        >
          Ödeme
        </Button>
      </Box>
