public class OrderStatusChangedConsumer : IConsumer<OrderStatusChangedConsumer>
{
    private readonly IEmailService _emailService;

    public OrderStatusChangedMessage(IEmailService emailService)
    {
    ...
    public async Task Consume(ConsumeContext<OrderStatusChangedMessage> context)
    {
        ...
        string body=m.NewStatus switch
        {
            ...
            "Delivered"=>
                 $"{m.OrderId} numaralı siparişiniz teslim edilmiştir.Bizi tercih ettiğiniz için teşekkürler." ,
             _ =>
