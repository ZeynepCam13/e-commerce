...
export default function Header() {
  ...
  <AppBar position="static" sx={{ mb: 4, backgroundColor: "white", color: "black" }}>
    ...
    >
      {/* 🔹 Eğer admin değilse kullanıcıya özel header */}
      {!isAdmin && (
        <>
          {/* Sol taraf: Menü + Kategoriler */}
      ...
      {/* Sağ taraf: Sepet, Favoriler veya Admin butonu */}
      <Box sx={{ display: "flex", alignItems: "center" }}>
        ...
        {isAdmin && (
          <Button component={NavLink} to="/admin" sx={{ ...navStyles, ml: 2 }}>
            Yönetim Paneli
          </Button>
        )}
