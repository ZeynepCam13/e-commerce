...
import { Link, NavLink, useNavigate } from "react-router"; // react-router-dom olarak güncellendi
...
export default function Header() {
  ...
  return (
    <AppBar
      position="sticky" // Sayfa kaydığında üstte kalır
      sx={{ 
          ...
          <Stack direction="row" spacing={1} alignItems="center">
            ...
            {user ? (
              <>
                ...
                >
                  {/* GÜVENLİ İSİM GÖSTERİMİ: user?.name kullanımı hatayı önler */}
                  {user?.name || "Hesabım"}
                </Button>
...
// Typography eksikliği için import'a eklemeyi unutmayın
