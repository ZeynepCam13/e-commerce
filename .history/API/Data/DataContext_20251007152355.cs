...
public class DataContext(DbContextOptions options) : IdentityDbContext<AppUser, AppRole, string>(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Product>().HasData(
            new List<Product> {
                new Product { Id=1, Name="Spor Ayakkabı", Description="Tommy Hilfiger", ImageUrl="images/1.webp", Price=7000, IsActive=true, Stock=100  },
                ...
                new Product { Id=9, Name="Süet Ceket", Description="Manuka", ImageUrl="9.webp", Price=1500, IsActive=true, Stock=100  },
