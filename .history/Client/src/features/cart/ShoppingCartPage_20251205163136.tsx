              ...
              >
                ...
                <TableCell align="right">
                  ...
                  <LoadingButton 
                    ...
                    onClick={() => 
                      dispatch(deleteItemFromCart({ productId: item.productId, quantity: 1, sizes:item.Sizes}))}>
                    <RemoveCircleOutline />
                  </LoadingButton>
                  </TableCell>
                ...
                <TableCell align="right">
                    <LoadingButton color="error" 
                      ...
                      onClick={() => 
                        dispatch(deleteItemFromCart({ productId: item.productId, quantity: item.quantity, sizes:item.Sizes}))}>
                        <Delete />
                    </LoadingButton>
                </TableCell>
              </TableRow>
