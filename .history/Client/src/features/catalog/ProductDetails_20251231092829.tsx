        ...
        <Grid item xs={12} md={6}>
          <Box sx={{ position: "sticky", top: 100 }}>
            <Box sx={{ position: "relative" }}>
              ...
              />
              {/* ANA RESİM ÜZERİ TÜKENDİ KATMANI (Trendyol/Zara Stili) */}
              {isGlobalOutOfStock && (
                <Box
                  sx={{
                    position: "absolute",
          ...
          <Box>
                  ...
                  <Box key={ps.id} sx={{ position: 'relative' }}>
                    <Button
                      ...
                      sx={{
                        ...
                        color: ps.stock === 0 ? "text.disabled" : (selectedSize === ps.size ? "white" : "black"),
                    ...
                    >
                      ...
                      {/* BEDEN ÜZERİ ÇAPRAZ ÇİZGİ (Zara Stili) */}
                      {ps.stock === 0 && (
                        <Box
                          sx={{
                            position: 'absolute',
            ...
            <Stack direction="row" spacing={2} sx={{ mt: 4, mb: 4 }}>
              <LoadingButton
                ...
                sx={{ 
                    bgcolor: (isSelectedSizeOutOfStock || isGlobalOutOfStock) ? "grey.400" : "black", 
                    py: 1.8,
                    fontWeight: 700,
                    "&:hover": { bgcolor: (isSelectedSizeOutOfStock || isGlobalOutOfStock) ? "grey.400" : "#333" } 
                }}
              >
