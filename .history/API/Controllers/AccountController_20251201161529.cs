...
public class AccountController : ControllerBase
{
    ...
    public AccountController(UserManager<AppUser> userManager, RoleManager<AppRole> roleManager, TokenService tokenService, DataContext context,IEmailService emailService,IPublishEndpoint publishEndpoint
)
    {
                  ...
                  await _publishEndpoint.Publish(new EmailMessage
{
    ...
    public IActionResult SendSmsCode([FromBody] string phone)
    {
       ...
       _smsService.Send(phone, $"Your verification code is: {code}");
