import { Lock, LockOutlined, Person, Person2Outlined, PersonAddAlt1Outlined, PersonAddRounded } from "@mui/icons-material";
    ...
    return (
        <Container maxWidth="xs">
            ...
            sx={{marginTop: 8,
             padding: 2,
              background:
            "linear-gradient(145deg, rgba(250,250,250,1) 0%, rgba(245, 245, 246, 0.91) 100%)", } } elevation={3}>
