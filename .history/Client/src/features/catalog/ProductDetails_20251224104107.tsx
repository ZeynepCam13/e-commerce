    ...
    <Box key={c.id} sx={{ pb: 3, borderBottom: "1px solid #f0f0f0" }}>
      <Stack direction="row" spacing={2} alignItems="center" mb={1}>
        <Box sx={{ 
          ...
          {/* GÜVENLİ HARF KONTROLÜ: Username veya ilk harf yoksa 'U' (User) göster */}
          {c.username && c.username.length > 0 ? c.username[0].toUpperCase() : 'U'}
        </Box>
        <Box>
          ...
          <Typography variant="caption" color="text.secondary">
            {/* Tarih varsa onu göster, yoksa bugünü göster */}
