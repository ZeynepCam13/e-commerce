...
export default function ShoppingCartPage()
{
    ...
    return (
      ...
      <Box display="flex" justifyContent="flex-end" sx={{ px: 5, py: 1.5, fontSize: "18px"}}>
        <Button component={Link}  to="/checkout/CheckoutPage" variant="contained" color="primary"> Ödeme </Button>
      </Box>
      </>
    );
}