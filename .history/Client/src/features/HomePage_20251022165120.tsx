  ...
  const sliderItems = [
    {
      ...
      title: "Yeni Sezon",
      subtitle: "En son trendleri ve zamansız klasikleri keşfedin",
    },
    {
      img: "/images/slide.jpg",
      title: "Yeni Kozmetik Trendleri",
      subtitle: "Doğallığın ve ışıltının birleştiği yepyeni koleksiyon",
    },
    {
      img: "/images/side3.webp",
      title: "Zamansız Parçalar",
      subtitle: "Kombinlerin tamamlayıcı parçalarını keşfedin",
    },
  ];
  ...
  return (
    <Box sx={{ backgroundColor: "#faf9f7" }}>
      ...
      <Container maxWidth="lg" sx={{ py: 8 }}>
        ...
        >
          Herkes için tasarlanmış modern, minimal ve zamansız parçalar.
        </Typography>
