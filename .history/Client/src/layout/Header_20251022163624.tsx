...
import { KeyboardArrowDown, Search, ShoppingCart,Menu as MenuIcon, Title} from "@mui/icons-material";
  ...
  <AppBar position="static" sx={{ mb: 4, backgroundColor: "white", color: "black" }}>
    ...
    >
      ...
      <Box sx={{ display: "flex", alignItems: "center" }}>
        ...
        {/* 🔹 Eğer adminse sadece Yönetim Paneli göster */}
        {isAdmin && (
          <Button component={NavLink} to="/admin" sx={{   justifyContent: "flex-end" }}>
            Yönetim Paneli
          </Button>
        )}
