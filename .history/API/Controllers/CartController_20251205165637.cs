...
public class CartController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<ActionResult> AddItemToCart(int productId, int quantity,string size)
    {
        ...
        return BadRequest(new ProblemDetails { Title = "Ürün stokta yok" });
    }

    [HttpDelete]
    public async Task<ActionResult> DeleteItemFromCart(int productId, int quantity,string Sizes)
    {
        var cart = await GetOrCreate((GetCustomerId()));

        cart.DeleteItem(productId, quantity,Sizes);
