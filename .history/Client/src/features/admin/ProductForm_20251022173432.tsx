...
useEffect(() => {
  const loadCategories = async () => {
    try {
      const res = await requests.Catalog.getCategories(); // res.data değil!
      console.log("Kategori verisi:", res);
      setCategories(res); // ✅ çünkü queries.get zaten response.data döndürüyor
    } catch (err) {
