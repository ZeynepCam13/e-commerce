...
export default function ProductDetails() {
  ...
  const isLowStock = currentStock !== null && currentStock > 0 && currentStock <= 6;
  ...
  return (
    <Box sx={{ maxWidth: 1200, mx: "auto", p: { xs: 2, md: 4 } }}>
      <Grid container spacing={6}>
        ...
        <Grid item xs={12} md={6}>
          <Box>
            ...
            {/* Stok Uyarıları - Sadece içerik varsa alan kaplar */}
            {(selectedSize && (isSelectedSizeOutOfStock || isLowStock)) && (
                <Box sx={{ mb: 2 }}>
            ...
            {/* Beden Seçimi */}
            <Box sx={{ mb: 3 }}>
              <Typography variant="subtitle1" fontWeight="bold" sx={{ mb: 1 }}>Beden Seçin</Typography>
      ...
      {/* Yorumlar ve Benzer Ürünler bölümleri değişmeden devam ediyor... */}
