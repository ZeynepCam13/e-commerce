            ...
            {cart?.cartItems.map((item) => (
              ...
              >
                 <TableCell component="th" scope="row">
                  <img src={`http://localhost:5198/${item.imageUrl}`} style={{height: 60}}/>
                </TableCell>
                <TableCell component="th" scope="row">
                  {item.name}
                </TableCell>
                ...
                <TableCell align="right">
                  <LoadingButton 
                    ...
                    onClick={() => dispatch(addItemToCart({ productId: item.productId,size:item.Sizes||"default"}))}>
                    <AddCircleOutline />
                  </LoadingButton>
                  {item.quantity}
                  <LoadingButton 
                    ...
                    onClick={() => 
                      dispatch(deleteItemFromCart({ productId: item.productId, quantity: 1, }))}>
                    <RemoveCircleOutline />
                  </LoadingButton>
                  </TableCell>
                ...
                <TableCell align="right">
                    <LoadingButton color="error" 
                      ...
                      onClick={() => 
                        dispatch(deleteItemFromCart({ productId: item.productId, quantity: item.quantity, }))}>
                        <Delete />
                    </LoadingButton>
                </TableCell>
              </TableRow>
