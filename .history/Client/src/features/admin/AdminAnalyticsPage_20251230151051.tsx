...
const [dailyChart, setDailyChart] = useState<SimpleChart[]>([]);
const [weeklyChart, setWeeklyChart] = useState<SimpleChart[]>([]);
...
useEffect(() => {
  ...
  setWeeklyChart([
    { name: "1. Hafta", count: 5 },
    { name: "2. Hafta", count: 3 },
    { name: "3. Hafta", count: 6 },
    { name: "4. Hafta", count: 2 },
  ]);
}, []);
...
>
  ...
  formatter={(value: any, name: any, props: any) => {
    const statusKey = String(props?.payload?.status ?? name);
