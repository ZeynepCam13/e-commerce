...
export default function ProductForm({ product, cancelEdit }: Props) {
  ...
  formData.append(`Sizes[${index}].Stock`, s.stock);
});
    ...
    <Box sx={{ display: "flex", justifyContent: "center", mt: 5 }}>
      <Paper sx={{ p: 4, width: 500 }}>
        ...
        <Box component="form" onSubmit={handleSubmit}>
          ...
          <div className="mt-4">
  <label className="font-medium">Bedenler</label>
  ...
  <button
    ...
    className="mt-3 px-3 py-1 bg-gray-100 border rounded hover:bg-gray-200"
  >
    + Beden Ekle
  </button>
</div>
